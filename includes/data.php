...
const FH_JOBS = [
  ...
  [
    'slug' => 'jomsite',
    'company' => 'JomSite',
    'city' => 'Kangar, Perlis, Malaysia · Remote',
    'from' => 'Jan 2025',
    'to' => null,
    'year' => '2025',
    'icon' => 'cloud',
    'stack' => ['Microsoft Azure', 'Zapier', 'React', 'Node.js', 'PHP', 'WordPress', 'MongoDB', 'AWS', 'Tailwind CSS', 'MySQL', 'REST API', 'Git'],
  ],
  [
    'slug' => 'jomsiteft',
    'company' => 'JomSite',
    'city' => 'Malaysia · Hybrid',
    'from' => 'Feb 2022',
    'to' => 'Jan 2025',
    'year' => '2022',
    'icon' => 'cloud',
    'stack' => ['React', 'Node.js', 'PHP', 'WordPress', 'MongoDB', 'AWS', 'Tailwind CSS', 'MySQL', 'REST API', 'JavaScript'],
  ],
  [
    'slug' => 'upwork',
    'company' => 'Upwork',
